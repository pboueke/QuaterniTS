...
| --------------------------------------------- | ------------------------------------------------------------------------------------------------ | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `new Chess()` / `new Chess(fen)`              | `new Quaternity(position?)`                                                                      | partial         | Defaults to the 64-piece starting position, or accepts a caller-supplied validated `Position` . No FEN constructor.                                                                                         |
...
| `reset()`                                     | `reset()`                                                                                        | equivalent      | Restores the starting position and clears the log.                                                                                                                                                          |
